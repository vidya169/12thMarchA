...
public class ex6_Treeset2_desending_order {
		...
		{		
			...
			System.out.println("----print all data using iterator---Treeset is by defult assending order--");
			...
			System.out.println("----print all data desending order-----");
			
			itr=tr.descendingIterator();
			while(itr.hasNext()) {
				System.out.println(itr.next());
			}
		}
